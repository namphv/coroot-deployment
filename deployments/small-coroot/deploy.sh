...
echo "    * Anchor (regular node): 2GB RAM, 50GB"
echo "    * Worker (spot node): 16-32GB RAM, 500GB"
...
echo "  - ClickHouse Worker (~16-32GB)"
echo "  Total: ~16-32GB (80-90% of traffic)"
echo ""
